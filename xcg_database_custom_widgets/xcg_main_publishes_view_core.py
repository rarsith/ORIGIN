...
from xcg_database_custom_widgets.xcg_main_publishes_view_UI import MainPublishesViewUI

from xcg_icons import *


img_path = "F:\\Radu_Work\\Pycharm_Projects\\Xchange\\xcg_icons\\play_icon_vsmall.png"
