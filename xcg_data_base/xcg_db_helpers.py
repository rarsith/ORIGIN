...
import xcg_utilities.xcg_utils
from xcg_data_base import xcg_db_queries as xqr


def get_entity(db_collection, branch, show_name=""):
    get_items = xcg_utilities.xcg_utils.db_find_dict_key(db_collection, branch, show_name=show_name)
    return get_items
