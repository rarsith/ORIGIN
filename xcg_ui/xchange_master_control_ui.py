...
from xcg_database_custom_widgets.xcg_slot_component_viewer_core import SlotComponentsViewerCore
...
class XchangeControlCenterUI(QtWidgets.QWidget):
    ...
    def get_task_status(self):
        try:
            task_status = xac.get_task_status(self.show_view_twd.comboBox_shows(),
    ...
    def get_sel_show_branch_category(self):
        branch_category = self.show_view_twd.get_sel_show_branch_category()
        return branch_category

    def get_entry_properties(self):
        spare_it = []
        db_connection = self.show_view_twd.get_sel_show_branch_category()
        definitions_list = xac.get_entry_definition(self.show_view_twd.comboBox_shows(),
                                                    db_connection,
                                                    self.show_view_twd.get_sel_category(),
                                                    self.show_view_twd.get_selected_entry_name())
    ...
    def get_definition_value(self, def_item):
        definition = xac.get_definition_element(self.show_view_twd.comboBox_shows(),
                                                self.show_view_twd.get_sel_show_branch(),
                                                self.show_view_twd.get_sel_category(),
                                                self.show_view_twd.get_selected_entry_name(),
                                                def_item)
