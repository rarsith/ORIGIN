...
class SetTaskImportsFromUI(QtWidgets.QDialog):
    ...
    def create_widgets(self):
        ...
        self.imports_from_lwd = xcg_task_imports_from_wdg.ImportsFromWidget()
        ...
        # self.imports_from_lwd.addItems(self.get_saved_import_schema())
    ...
    def remove_import_task_slot(self):
        listItems = self.imports_from_lwd.currentItem()
        selected_index = self.imports_from_lwd.indexFromItem(listItems)
        remove_it =  selected_index.row()
        self.imports_from_lwd.takeTopLevelItem(remove_it)
    ...
    def db_commit(self):
        xac.remove_all_task_import_slots(self.show_name_cb.currentText(),
