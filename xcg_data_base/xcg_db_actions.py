...
from  xcg_utilities.xcg_date_time import XcgDateTime
...
if __name__=="__main__":
    ...
    os.environ['XCG_PROJECT_CATEGORY'] = 'props'
    os.environ['XCG_PROJECT_ENTITY'] = 'knifeDark'
    os.environ['XCG_ENTITY_TASK'] = 'rigging'
    #
    #
