...
import xcg_database_custom_widgets.xcg_task_publishing_slots_core
reload(xcg_database_custom_widgets.xcg_task_publishing_slots_core)

import xcg_database_custom_widgets.xcg_task_imports_from_core
reload(xcg_database_custom_widgets.xcg_task_imports_from_core)
